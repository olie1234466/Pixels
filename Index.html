...
// Player setup
let player = { x:0, y:groundY-20, size:20, vx:0, vy:0, onGround:true, health:100 };
const gravity = 0.6;
...
canvas.addEventListener("touchend", e=>{
  ...
  if(dy<-30 && player.onGround){
    ...
    if(Math.abs(dx)>20) player.vx += dx>0?5:-5;
